...
```json
{
  ...
  "problem_contract": {
    ...
    "domain": {
      "description": "Draft source observation in Group Theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:um-amr-010-0302-questions-in-geometric-group-theory-q-17b8e57a",
    "quantifiers": [
      {
